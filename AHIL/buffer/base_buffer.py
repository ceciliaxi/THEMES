...
class BaseBuffer:
    def __init__(self,
        ...
        self.weight_buf     = np.zeros([total_size           ], dtype = np.float32) # REVISED HERE (10/20/21)
    ...
    def store(self,
        ...
        self.weight_buf    [self.ptr] = weight # REVISED HERE (10/20/21)
    ...
    def _take_from(self,
        ...
        return dict(
            ...
            weight     = self.weight_buf    [indices],
        )
